            ...
            <section id="laptop" className="container-fluid pt-5 pb-5 bg-light text-dark">
                ...
                <div className="row">
                    ...
                    <div className="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-lg-3">
                        <div className="container">
                            <div className="card bg-light" style={{ width: 300 }}>
                                <img className="card-img-top" src="./img/lt_rog.png" alt="Card" style={{ maxWidth: '100%', height: 250 }} />
                                <div className="card-body text-center">
                    ...
                    <div className="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-lg-3">
                        <div className="container">
                            <div className="card bg-light" style={{ width: 300 }}>
                                <img className="card-img-top" src="./img/lt_hp.png" alt="Card" style={{ maxWidth: '100%', height: 250 }} />
                                <div className="card-body text-center">
                    ...
                    <div className="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-lg-3">
                        <div className="container">
                            <div className="card bg-light" style={{ width: 300 }}>
                                <img className="card-img-top" src="./img/lt_lenovo.png" alt="Card" style={{ maxWidth: '100%', height: 250 }} />
                                <div className="card-body text-center">
